...
1.  Set up Azure Pass
2.  Programming primer ([Javascript Lab](https://notebooks.azure.com/library/jsprimer))

Lunch – 11:45 am – 12:45 pm

Section 4: 90 mins – 12:45 pm

1.  Cognitive Services deep dive ([LUIS Lab](https://github.com/Microsoft/BotBuilder-Samples/tree/master/Node/intelligence-LUIS#luis-application), [Text Analytics API Ref Lab](https://github.com/Azure/bot-education/blob/master/Student-Resources/Labs/CSharp/CognitiveServicesLab_API_ref.md))
...
4.  UPS bot demo (Deploy your own with [this](https://bots.botframework.com/bot?id=UPSBot) link to Skype)
